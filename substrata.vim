...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#2b2b2b', '#cf8164', '#76a065', '#ab924c', '#8296b0', '#a18daf', '#659ea2', '#b5b4c9', '#363636', '#fe9f7c', '#92c47e', '#d2b45f', '#a0b9d8', '#c6aed7', '#7dc2c7', '#f0ecfe']
  if has('nvim')
  ...
  hi Normal guifg=#b5b4c9 guibg=#1c1c1c gui=NONE cterm=NONE
  hi Cursor guifg=#1c1c1c guibg=#f0ecfe gui=NONE cterm=NONE
  hi None guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi CursorLineNr guifg=#454545 guibg=#212121 gui=NONE cterm=NONE
  hi FoldColumn guifg=#303030 guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#3b3b3b guibg=#262626 gui=NONE cterm=NONE
  hi LineNr guifg=#3b3b3b guibg=NONE gui=NONE cterm=NONE
  hi MatchParen guifg=#f0ecfe guibg=#2b2b2b gui=bold cterm=bold
  hi SignColumn guifg=#303030 guibg=NONE gui=NONE cterm=NONE
  hi Ignore guifg=#303030 guibg=NONE gui=NONE cterm=NONE
  hi Pmenu guifg=#b5b4c9 guibg=#262626 gui=NONE cterm=NONE
  hi PmenuSbar guifg=#262626 guibg=#262626 gui=NONE cterm=NONE
  hi PmenuSel guifg=#f0ecfe guibg=#212121 gui=NONE cterm=NONE
  hi PmenuThumb guifg=#212121 guibg=#212121 gui=NONE cterm=NONE
  hi ErrorMsg guifg=#fe9f7c guibg=NONE gui=NONE cterm=NONE
  hi ModeMsg guifg=#363636 guibg=NONE gui=NONE cterm=NONE
  ...
  hi ColorColumn guifg=NONE guibg=#212121 gui=NONE cterm=NONE
  hi CursorColumn guifg=NONE guibg=#212121 gui=NONE cterm=NONE
  hi CursorLine guifg=NONE guibg=#212121 gui=NONE cterm=NONE
  hi QuickFixLine guifg=NONE guibg=#2b2b2b gui=NONE cterm=NONE
  hi StatusLine guifg=#1c1c1c guibg=#212121 gui=NONE cterm=NONE
  hi StatusLineNC guifg=#6c6f82 guibg=#1c1c1c gui=NONE cterm=NONE
  hi VertSplit guifg=#2b2b2b guibg=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#1c1c1c guibg=#b5b4c9 gui=NONE cterm=NONE
  hi IncSearch guifg=#1c1c1c guibg=#b5b4c9 gui=NONE cterm=NONE
  hi Search guifg=#1c1c1c guibg=#8296b0 gui=NONE cterm=NONE
  hi Visual guifg=NONE guibg=#262626 gui=NONE cterm=NONE
  hi DiffAdd guifg=#92c47e guibg=#1c2316 gui=NONE cterm=NONE
  hi DiffChange guifg=NONE guibg=#262626 gui=NONE cterm=NONE
  hi DiffDelete guifg=#fe9f7c guibg=#2d1d16 gui=NONE cterm=NONE
  hi DiffText guifg=#d2b45f guibg=#262011 gui=NONE cterm=NONE
  hi Comment guifg=#404040 guibg=NONE gui=italic cterm=italic
  ...
  let g:limelight_conceal_guifg = '#363636'
  ...
  hi markdownUrl guifg=#363636 guibg=NONE gui=underline cterm=underline
  hi markdownCode guifg=NONE guibg=#262626 gui=NONE cterm=NONE
  hi markdownFaded guifg=#363636 guibg=NONE gui=NONE cterm=NONE
...
" Background: dark
" Color: base0        #1c1c1c ~ ; Background
" Color: base1        #212121 ~ ; Slightly lighter
" Color: base2        #262626 ~ ; Much lighter
" Color: base3        #2b2b2b ~ ; Lightest
" Color: base4        #303030 ~ ; Almost invisible
" Color: base5        #363636 ~ ; Much darker
" Color: base6        #3b3b3b ~ ; Slightly darker
